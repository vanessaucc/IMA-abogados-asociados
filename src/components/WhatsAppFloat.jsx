...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    ...
    const pulseTimer = setInterval(() => setPulsing(p => !p), 3000)
  ...
  return (
    ...
    >
      <div className={`${styles.pulse} ${pulsing ? styles.pulseActive : ''}`} />
      ...
      <span className={styles.tooltip}>¡Consulta gratis!</span>
    </a>
  )
}
